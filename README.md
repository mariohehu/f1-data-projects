...
Four end-to-end Formula 1 data projects — machine learning, anomaly detection, a full web app, and statistical analysis — built on real F1 timing data via [FastF1](https://github.com/theOehrly/Fast-F1) and the [Jolpica API](https://github.com/jolpica/jolpica-f1).
...
`Python 3` · `XGBoost` · `scikit-learn` · `pandas` · `Streamlit` · `Plotly` · `seaborn` · `Next.js 14` · `TypeScript` · `Recharts` · `FastF1` · `Jolpica API`
